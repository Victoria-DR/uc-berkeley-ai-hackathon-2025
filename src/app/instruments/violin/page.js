...
export default function ViolinRecordingPage() {
  ...
  const handleAnalyzePerformance = async () => {
    ...
    try {
      ...
      const result = await analyzeAudio("Violin", musicType || "Unknown Piece", base64Audio)
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          {(recordedAudio || uploadedFile) && (
            <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-500">
              <Button
                className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 shadow-lg transform transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              ...
              <form onSubmit={handleChatSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Vivaldi Four Seasons, Bach Partita, Mendelssohn Concerto..."
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-2xl max-h-[80vh] bg-white shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-xl font-semibold text-gray-900">Violin Performance Analysis</h3>
              <Button
                variant="ghost"
                size="sm"
