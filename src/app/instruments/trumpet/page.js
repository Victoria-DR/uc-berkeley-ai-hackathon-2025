...
export default function TrumpetRecordingPage() {
  ...
  const handleAnalyzePerformance = async () => {
    ...
    try {
      ...
      const result = await analyzeAudio("Trumpet", musicType || "Unknown Piece", base64Audio)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-rose-50 to-pink-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <Music className="absolute top-20 left-20 w-6 h-6 text-red-300 animate-float" />
        <Music className="absolute top-40 right-32 w-4 h-4 text-rose-300 animate-float animation-delay-1000" />
        <Music className="absolute bottom-40 left-32 w-5 h-5 text-pink-300 animate-float animation-delay-2000" />
        <Sparkles className="absolute top-60 right-20 w-5 h-5 text-red-400 animate-pulse" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-red-500 to-rose-500 rounded-full shadow-lg mb-4">
          ...
          {/* Selected Music Type */}
          {musicType && (
            <Card className="p-4 bg-gradient-to-r from-red-50 to-rose-50 border-red-200 shadow-md">
              <div className="flex items-center justify-center space-x-2">
                <Music className="w-5 h-5 text-red-600" />
                <span className="text-red-800 font-medium">Practicing: {musicType}</span>
              </div>
            </Card>
          )}
            ...
            <Card className="p-6 bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-green-400 to-rose-500 rounded-full flex items-center justify-center">
          ...
          {(recordedAudio || uploadedFile) && (
            <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-500">
              <Button
                className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 shadow-lg transform transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              ...
              <form onSubmit={handleChatSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Haydn Concerto, Hummel Concerto, Clarke Trumpet Voluntary..."
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-2xl max-h-[80vh] bg-white shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-xl font-semibold text-gray-900">Trumpet Performance Analysis</h3>
              <Button
                variant="ghost"
                size="sm"
