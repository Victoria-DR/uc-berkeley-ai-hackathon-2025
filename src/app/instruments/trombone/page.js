...
export default function TromboneRecordingPage() {
  ...
  const handleAnalyzePerformance = async () => {
    ...
    try {
      ...
      const result = await analyzeAudio("Trombone", musicType || "Unknown Piece", base64Audio)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 left-40 w-80 h-80 bg-zinc-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>

      {/* Floating music notes */}
      <div className="absolute inset-0 pointer-events-none">
        <Music className="absolute top-20 left-20 w-6 h-6 text-slate-300 animate-float" />
        <Music className="absolute top-40 right-32 w-4 h-4 text-gray-300 animate-float animation-delay-1000" />
        <Music className="absolute bottom-40 left-32 w-5 h-5 text-zinc-300 animate-float animation-delay-2000" />
        <Sparkles className="absolute top-60 right-20 w-5 h-5 text-slate-400 animate-pulse" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-slate-500 to-gray-500 rounded-full shadow-lg mb-4">
          ...
          {/* Selected Music Type */}
          {musicType && (
            <Card className="p-4 bg-gradient-to-r from-slate-50 to-gray-50 border-slate-200 shadow-md">
              <div className="flex items-center justify-center space-x-2">
                <Music className="w-5 h-5 text-slate-600" />
                <span className="text-slate-800 font-medium">Practicing: {musicType}</span>
              </div>
            </Card>
          )}
            ...
            <Card className="p-6 bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-green-400 to-gray-500 rounded-full flex items-center justify-center">
          ...
          {(recordedAudio || uploadedFile) && (
            <div className="space-y-4 animate-in slide-in-from-bottom-4 duration-500">
              <Button
                className="w-full h-14 text-lg font-semibold bg-gradient-to-r from-slate-500 to-gray-500 hover:from-slate-600 hover:to-gray-600 shadow-lg transform transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              ...
              <form onSubmit={handleChatSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., David Concertino, Grøndahl Concerto, Rota Concerto..."
                ...
                <div className="flex space-x-3">
                  ...
                  <Button
                    type="submit"
                    className="flex-1 bg-gradient-to-r from-slate-500 to-gray-500 hover:from-slate-600 hover:to-gray-600"
                  >
                    Set Title
                  </Button>
                </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <Card className="w-full max-w-2xl max-h-[80vh] bg-white shadow-2xl overflow-hidden">
            <div className="p-6 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-xl font-semibold text-gray-900">Trombone Performance Analysis</h3>
              <Button
                variant="ghost"
                size="sm"
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end">
              <Button
                onClick={() => setShowAnalysisModal(false)}
                className="bg-gradient-to-r from-slate-500 to-gray-500 hover:from-slate-600 hover:to-gray-600"
              >
                Close
              </Button>
            </div>
